# Performance Optimizations for Nurse Supply Oracle

This document outlines the performance optimizations implemented to achieve sub-second response times in the Nurse Supply Oracle application.
...
1. **Adjust model size**
   - Use `mistralai/Mistral-7B-Instruct` for faster inference
